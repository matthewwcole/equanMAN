    ...
    final timerChoices = await showDialog(
      ...
      if (timerChoices != null) {
        if (timerChoices == 'custom') {
          Duration selectedDuration = const Duration(minutes: 15); // Default value and this is what VSCode gave us after a tab. 
                  ...
                  child: GestureDetector(
                    child: CupertinoTimerPicker(
                      ...
                      onTimerDurationChanged: (Duration newDuration) {
                        selectedDuration = newDuration; //Store the picked duration here
                      },   
                    ),
                  ),
                ),
          ...
          _timerLogic.startTimer(0, timerChoices, 0); // start timer with timerChoices minutes
        }
      }
  }
